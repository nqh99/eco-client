...
const Navbar = () => {
  ...
  return (
    <header
      className={`navbar-header block w-full min-w-[320px top-0 z-50 shadow-md bg-[rgba(255,255,255,0.9)] `}
    >
      <MiniNavbar />
      <nav
      ...
      >
        ...
        <div className="frame-nav w-[80%] flex flex-col">
          <div className="relative flex w-full gap-[5%] h-[65%] justify-between items-center">
            <SearchBar />
            <div className="relative flex flex-row w-[35%] gap-5 justify-center items-center">
              <Notification />
              <Cart />
              <Button></Button>
              <Login />
