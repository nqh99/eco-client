    ...
    <div className={`mb-4 ${fullWidth ? 'w-full' : 'w-auto'}`}>
      ...
      <div className="relative flex items-center">
        <InputElement
          ...
          onChange={onChange}
          onBlur={handleBlur}
          className={`block w-full rounded-lg p-3 pr-10 text-sm focus:outline-none ${
            error
              ? 'border-1 border border-red-500 text-red-900 focus:border-red-500 focus:ring-red-500'
              : 'border-1 border border-gray-300 text-gray-700 placeholder-gray-400 focus:border-green-500 focus:ring-green-500'
