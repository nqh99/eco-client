...
import { removeCartItems } from "@/lib/features/checkout/cartSlice";
  ...
  const handleSubmit = async () => {
    ...
    if (!hasErrors) {
      ...
      const formedUserData: UserOrderMdl = {
        ...
        totalPrice: orderCal.getPromotionPrice() + shippingPrice,
      };
    ...
    <div className="p-6 rounded-lg shadow-md grid grid-cols-12 gap-6 bg-[#f9f9f9]">
      ...
      <div className="col-span-4 lg:col-span-12">
        ...
        <div className="p-4 bg-white rounded-lg shadow-md mt-4">
          ...
          <Popup show={isOrderSuccess} title="Đặt hàng thành công">
            <Button
              onClick={() => {
                dispatch(removeCartItems(cartPayload));
                // router.push("/");
