...
const paymentMethods = [
  ...
  },
  {
    ...
    accountInfo: [
      {
        name: 'Cty TNHH DT TM và DV QT Eco-HHB',
...
const PaymentPage: React.FC = () => {
  ...
  return (
    <div className="grid grid-cols-12 gap-6 rounded-lg bg-[#f9f9f9] p-6 shadow-md">
        ...
        <div className="mt-4 rounded-lg bg-white p-4 shadow-md">
          ...
          <div className="mb-3 flex justify-between">
            ...
            <div className="flex flex-col items-end">
              ...
              <span className="mb-3 text-xs text-informal">
          ...
          <Button
            ...
            className="w-full rounded-md bg-red-600 px-3 py-2 text-center text-white"
          >
            Đặt hàng
          </Button>
        </div>
